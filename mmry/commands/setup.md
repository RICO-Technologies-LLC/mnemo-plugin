...
After setup completes, tell the user: "You're all set. Restart Claude Code and your memories will start loading automatically. Type /mmry:help anytime for a quick reference."
